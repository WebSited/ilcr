            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Room 332, Professorial Wing, School of Environmental Complex <br> Federal University of Technology Minna, Gidwan-Kwano Campus, <br> Minna, Niger State, Nigeria.</p>
                </div>
              </div>
              <div class="col-md-6">
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>ILCR</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
