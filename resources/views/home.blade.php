                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p style="text-align: justify">
                            <br>
                            Institute for Land and Community Resilience was established to build human and community
                            capacity through formal and
                            informal education and awareness creation among local communities in Nigeria on land and
                            emergencies related matters.
                            <br />
                            <br>
                            Land disputes, land degradations, loss of tenure, climate change actions as a result of low
                            capacity,
                            poor implementation of polices and low risk awareness and emergency preparedness are major
                            re-occurring issues in
                            Nigeria and other developing nations.
                            <br />
                            <a href="{{ route('about') }}" class="btn btn-success text-white" style="margin-top: 5px;">Read
                                More</a>
                        </p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 " data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box iconbox-blue">
                            ...
                            <a href="{{ route('pgd') }}" class="btn btn-success text-white" style="font-size: 0.9rem;">MORE
                                INFO</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 " data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box iconbox-orange">
                            ...
                            <a href="{{ route('masters') }}" class="btn btn-success text-white"
                                style="font-size: 0.9rem;">MORE INFO</a>
                        </div>
                    </div>
