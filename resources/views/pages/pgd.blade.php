        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              ...
              <p class="description">The proposed programme will align her objectives to that of the Network of Excellence on Land Governance in Africa (NELGA).</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight">
              ...
              <p class="description">The Vision of the Centre is to become a reference point in the field of Community Emergency Awareness and Preparedness in Nigeria.</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <p class="description" style="font-size: 16px">The mission is to build highly skilled human capital for a safer community through modern technology.
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
              ...
              <p class="description" style="font-size: 14px">The candidate after completion of the programme will be competent in Land Management, Land Governance, Land Administration, Geographic Information System, Gender issues in Land Management, Land and poverty, Land and corruption.
              </p>
            </div>
          </div>
