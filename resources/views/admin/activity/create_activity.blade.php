    ...
    <div class="card-body">
      ...
      <form action="{{ route('store.activity') }}" method="POST" enctype="multipart/form-data" class="forms-sample" >
        ...
        <div class="form-group">
          ...
          <textarea name="may" id="editor41" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="june" id="editor5" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="july" id="editor6" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="august" id="editor7" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="september" id="editor8" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="october" id="editor9" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="november" id="editor10" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
        ...
        <div class="form-group">
          ...
          <textarea name="december" id="editor11" rows="10" cols="80">
            {{ old('body') }}
        </textarea>
        <script>
