            ...
            <div class="faq-list">
                <ul>
                    ...
                    <li data-aos="fade-up" data-aos-delay="100">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-2"
                    ...
                    <li data-aos="fade-up" data-aos-delay="200">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-3"
                    ...
                    <li data-aos="fade-up" data-aos-delay="300">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-4"
                    ...
                    <li data-aos="fade-up" data-aos-delay="400">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-5"
                    ...
                    <li data-aos="fade-up" data-aos-delay="500">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-6"
                    ...
                    <li data-aos="fade-up" data-aos-delay="600">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-7"
                    ...
                    <li data-aos="fade-up" data-aos-delay="700">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-8"
                    ...
                    <li data-aos="fade-up" data-aos-delay="800">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-9"
                    ...
                    <li data-aos="fade-up" data-aos-delay="900">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-10"
                    ...
                    <li data-aos="fade-up" data-aos-delay="1000">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-11"
                    ...
                    <li data-aos="fade-up" data-aos-delay="1100">
                        <i class=""></i> <a data-toggle="collapse" href="#faq-list-12"
